...
# https://github.com/Josh-Jo1/Python/blob/master/Python%20Code%20Challenges%20-%20LinkedIn%20Learning/13%20Solve%20a%20Sudoku.py
...
print(solveSudoku(easyPuzzle))
print(solveSudoku(mediumPuzzle))
print(solveSudoku(hardPuzzle))
